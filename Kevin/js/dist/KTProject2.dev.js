...
var htmlChanger6 = document.querySelector(".html-changer-6"); // array 1: images for 1st container of image

var imageGallery = [// image url (6)
"", // this is a decoy since loop starts at index(1)
"https://kevintran1.s3.us-east-2.amazonaws.com/images/waterfall.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/pyramid.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/skyscraper.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/tokyo.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/snow.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/eiffel-tower.jpg"]; // array 1: images for 2nd container of image

var imageGallery2 = [// image url (6)
"", // this is a decoy since loop starts at index(1)
"https://kevintran1.s3.us-east-2.amazonaws.com/images/pyramid.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/skyscraper.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/tokyo.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/snow.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/eiffel-tower.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/waterfall.jpg"]; // array 1: images for 3rd container of image

var imageGallery3 = [// image url (6)
"", // this is a decoy since loop starts at index(1)
"https://kevintran1.s3.us-east-2.amazonaws.com/images/skyscraper.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/tokyo.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/snow.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/eiffel-tower.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/waterfall.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/pyramid.jpg"]; // array 1: images for 4th container of image

var imageGallery4 = [// image url (6)
"", // this is a decoy since loop starts at index(1)
"https://kevintran1.s3.us-east-2.amazonaws.com/images/tokyo.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/snow.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/eiffel-tower.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/waterfall.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/pyramid.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/skyscraper.jpg"]; // array 1: images for 5th container of image

var imageGallery5 = [// image url (6)
"", // this is a decoy since loop starts at index(1)
"https://kevintran1.s3.us-east-2.amazonaws.com/images/snow.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/eiffel-tower.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/waterfall.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/pyramid.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/skyscraper.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/tokyo.jpg"]; // array 1: images for 6th container of image

var imageGallery6 = [// image url (6)
"", // this is a decoy since loop starts at index(1)
"https://kevintran1.s3.us-east-2.amazonaws.com/images/eiffel-tower.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/waterfall.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/pyramid.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/skyscraper.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/tokyo.jpg", "https://kevintran1.s3.us-east-2.amazonaws.com/images/snow.jpg"]; // array 2: title

var titles = [// titles (3)
"", "Waterfall", "Pyramids", "Skyscraper", "Tokyo Tower", "Snow Mountain", "Eiffel Tower"]; // array 3: sentences

var sentences = [// sentences (3)
"", "Waterfalls are the signs of nature and beauty. Wherever you go, you will sense the art the feeling of peace and freedom. One should explore the secrets of the waterfall", "Pyramids are the sign of culture and spirituality. The pyramids contain a big history of events that many people strive the know about. There tends to be a lot of mystery behind the pyramid as well", "The skyscraper is a magnificent building that has a lot of innovation to it. Skyscrapers are great for businesses. Working in a nice skyscraper helps people's health and mentality", "Tokyo Tower is a great building to visit for vacation. It contains a lot of history based on its culture. It shows peace and harmony in the world", "The Snow mountain is a great place for skiing. The weather is extremely cold. People often love to snowboard here", "The Eiffel tower represents peace and love. The structure was created as the symbolism of France. Love is mostly sparked around this building"]; // addition array 4: link to detailed pages for 2nd image container

var pages = [// pages
"", "waterfall.html", "pyramid.html", "skyscraper.html", "tokyo.html", "snow.html", "eiffel.html"]; // addition array 4: link to detailed pages for 2nd image container

var pages2 = ["", "pyramid.html", "skyscraper.html", "tokyo.html", "snow.html", "eiffel.html", "waterfall.html"]; // addition array 4: link to detailed pages for 3rd image container

var pages3 = ["", "skyscraper.html", "tokyo.html", "snow.html", "eiffel.html", "waterfall.html", "pyramid.html"]; // addition array 4: link to detailed pages for 4th image container

var pages4 = ["", "tokyo.html", "snow.html", "eiffel.html", "waterfall.html", "pyramid.html", "skyscraper.html"]; // addition array 4: link to detailed pages for 6th image container

var pages5 = ["", "snow.html", "eiffel.html", "waterfall.html", "pyramid.html", "skyscraper.html", "tokyo.html"]; // addition array 4: link to detailed pages for 6th image container

var pages6 = ["", "eiffel.html", "waterfall.html", "pyramid.html", "skyscraper.html", "tokyo.html", "snow.html"]; // function to change image, title, and sentences in a time frame
...
var unfavButton2 = document.createElement("button");
var favButton3 = document.createElement("button");
var unfavButton3 = document.createElement("button");
var favButton4 = document.createElement("button");
var unfavButton4 = document.createElement("button");
var favButton5 = document.createElement("button");
var unfavButton5 = document.createElement("button");
var favButton6 = document.createElement("button");
var unfavButton6 = document.createElement("button"); // specify classes for buttons
...
favButton6.className = "fav-button-6"; // unfavorite button specified
...
unfavButton6.className = "unfav-button-6"; // specify text for buttons
...
unfavButton6.textContent = "Unfavorite"; // append buttons with appendChild()

var imgContainer1 = document.querySelector(".img-1");
var imgContainer2 = document.querySelector(".img-2");
var imgContainer3 = document.querySelector(".img-3");
var imgContainer4 = document.querySelector(".img-4");
var imgContainer5 = document.querySelector(".img-5");
var imgContainer6 = document.querySelector(".img-6"); // appending child to all 6 pictures
...
imgContainer6.appendChild(unfavButton6); // inserting icons
...
unfavButton2.addEventListener('click', function () {
...
favButton3.addEventListener('click', function (e) {
  e.preventDefault();
...
unfavButton3.addEventListener('click', function () {
...
favButton4.addEventListener('click', function (e) {
  e.preventDefault();
...
unfavButton4.addEventListener('click', function () {
...
favButton5.addEventListener('click', function (e) {
  e.preventDefault();
...
unfavButton5.addEventListener('click', function () {
...
favButton6.addEventListener('click', function (e) {
  e.preventDefault();
...
unfavButton6.addEventListener('click', function () {
